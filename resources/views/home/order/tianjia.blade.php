...
@section('address')
    ...
    <body style="cursor: auto;">
        ...
        <div class="block_s" style="padding-bottom:20px;">
            ...
            <form action="/home/insert" method="get" name="theForm" id="theForm" >
                        {{ csrf_field() }}
                                    ...
                                    <tbody>
                                        ...
                                        <tr height="45">
                                            ...
                                            <td style="text-align:left;" bgcolor="#ffffff">
                                                <input name="address" value="" size="60" class="ipt" id="address_0" type="text">
                                                <span class="dizhi">
                                                    (务必填写正确!)
                                                </span>
                                            </td>
                                        ...
                                        <tr height="45">
                                            ...
                                            <td style="text-align:left;" bgcolor="#ffffff">
                                                <input name="phone" value="" class="ipt" id="tel_0" type="text">
                                                <span class="red">
                                                    (必填)
                                                </span>
                                            </td>
                                         ...
                                         <tr height="45">
                                            ...
                                            <td style="text-align:left;" bgcolor="#ffffff">
                                                <input name="name" value="" class="ipt" id="tel_0" type="text">
                                                <span class="name">
                                                    (必填)
                                                </span>
                                            </td>
