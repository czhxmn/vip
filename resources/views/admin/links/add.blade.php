...
@section('content')
    ...
    <div class="widget-body am-fr">
        <form class="am-form tpl-form-line-form" action='/admin/links' method="post" enctype="multipart/form-data">
            @if (count($errors) > 0)
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-9">
                    <input type="text" class="tpl-form-input" name='linkname' id="user-name" placeholder="请输入链接标题">
                    <small>
                        请填写链接标题
                    </small>
                </div>
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-9">
                    <input type="text" class="tpl-form-input" name='url' id="user-name" placeholder="请输入链接地址" value='https://www.'>
                    <small>
                        请填写链接地址
                    </small>
                </div>
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-9">
                    <textarea class="" rows="10" id="user-intro" name='ltext' placeholder="请输链接详情">
                    </textarea>
                </div>
            </div>
            <div class="am-form-group">
